...
import (
	...
	"github.com/premkagranicoinswitch/pdfcpu/internal/corefont/metrics"
...
func (fd TTFLight) unicodeRangeBits(id string) []int {
	...
	// Please go to https://github.com/premkagranicoinswitch/pdfcpu/issues/new/choose for an extension request.
	//
